...
/**
 * Demonstrates the grayscaled and morphing operations featured by Runigram.java.
 ...
 * For example, to morph the cake into a black and white cake image in 50 steps, use:
...
public class Editor4 {
    public static void main(String[] args) {
        ...
        Color[][] gsImage = Runigram.grayScaled(sourceImage);
        Runigram.setCanvas(sourceImage);
        Runigram.morph(sourceImage, gsImage, n);
    }
}
